...
# ***************************************************************************** #
# The sections below are for reference only and are not used in the solution
# These sections show how you can add prompt engineering, schema validation,
# and query rewriting into the application to provide a more robust generation experience
# ***************************************************************************** #
# class OpenDomainQA:
#     """Perform Natural Language to OC query generation using Bedrock and LlamaIndex"""
